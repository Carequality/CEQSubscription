...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic">
      <sch:assert test="count(f:extension[@url = 'https://sequoiaproject.org/fhir/sphd-r4/StructureDefinition/CEQEventCode']) &gt;= 1">extension with URL = 'https://sequoiaproject.org/fhir/sphd-r4/StructureDefinition/CEQEventCode': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://sequoiaproject.org/fhir/sphd-r4/StructureDefinition/CEQEventCode']) &lt;= 1">extension with URL = 'https://sequoiaproject.org/fhir/sphd-r4/StructureDefinition/CEQEventCode': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>Basic.extension.extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>Basic.extension.value[x] 1</sch:title>
