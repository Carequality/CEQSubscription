...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Subscription/f:extension</sch:title>
    <sch:rule context="f:Subscription/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'subPurpose']) &lt;= 1">extension with URL = 'subPurpose': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Subscription.extension.extension</sch:title>
    <sch:rule context="f:Subscription/f:extension/f:extension">
  ...
  <sch:pattern>
    <sch:title>f:Subscription/f:extension/f:extension</sch:title>
    <sch:rule context="f:Subscription/f:extension/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Subscription.extension.extension.extension</sch:title>
    <sch:rule context="f:Subscription/f:extension/f:extension/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Subscription.extension.extension.value[x] 1</sch:title>
    <sch:rule context="f:Subscription/f:extension/f:extension/f:value[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Subscription.extension.value[x] 1</sch:title>
    <sch:rule context="f:Subscription/f:extension/f:value[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
